...
SELECT countries.name as country_name, COUNT(cities.id) as number_of_cities FROM countries
...
SELECT cities.name as city_name, cities.population, cities.country_id FROM cities
...
SELECT countries.name as country_name, cities.name as city_name, cities.district, cities.population as city_population FROM cities
JOIN countries ON countries.id = cities.country_id
